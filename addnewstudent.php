        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="issue.php" class="list-group-item"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> Issue and Return</a>
              <a href="addnewstudent.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add a Student</a>
          ...
          <div class="panel panel-default">
            ...
            <form method="post" action="addnewstudent_insert.php" onsubmit="return Validate()">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="" placeholder="Reg No" name="regno">
                </div>
                <div class="form-group">
                  <label for="">Student Name</label>
                  <input type="text" class="form-control" id="" placeholder="Enter student Name" name="stu_name" required>
                </div>
                  <div class="form-group">
