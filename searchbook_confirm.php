        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="viewbook_stu.php" class="list-group-item"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> View Books</a>
              <a href="searchbook_stu.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> Search Books</a>
            </div>
        </div>
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $keyword=$_POST['key'];
              $result = mysqli_query($con,"SELECT * FROM books WHERE title LIKE '%$keyword%' OR author LIKE '%$keyword%' OR publisher LIKE '%$keyword%'");
              ...
              echo "No such books found... Try with another keyword";
