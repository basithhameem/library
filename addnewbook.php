        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="addnewbook.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span> Add New Book</a>
          ...
          <div class="panel panel-default">
            ...
            <form method="post" action="addnewbook_insert.php" onsubmit="return Validate()">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="" placeholder="Enter ISBN" name="isbn" required>
                </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="p1" placeholder="In indian Rupees" name="price" required>
                </div>
