        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="mybook_stu.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> My Books</a>
            </div>
        </div>
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $sname=$row['stu_name'];   
              echo $sname;
              $result = mysqli_query($con,"SELECT * FROM issue_register where stud_name='$sname'"); 
              ...
              echo " Database is empty!!! Lend some books!!!";
