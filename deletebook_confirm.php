        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="deletebook.php" class="list-group-item  active main-color-bg"><span class="glyphicon glyphicon-erase" aria-hidden="true"></span> Delete a Book</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $bid=$_POST['bookno'];
              $result = mysqli_query($con,"Delete FROM books where bookno=$bid");
              if($result)
              {
