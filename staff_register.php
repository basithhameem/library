  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-book" aria-hidden="true"></span>     Library Management System</h1>
          </div>
        </div>
      </div>
    </header>
<br><br><br>
        ...
        <div class="container">
          <div class="row">
            ...
            <br>
              <h2 style="margin-bottom: 30px;"><span class="glyphicon glyphicon-book" aria-hidden="true"></span>    Staff&nbsp    |&nbsp Registration</h2>
              <form method="post" action="staff_register_insert.php" onsubmit="return Validate()">
                <div class="form-group">
                  <label for="">Staff ID</label>
                  <input type="text" class="form-control" id="" placeholder="Staff ID" name="staffid">
                </div>
                <div class="form-group">
                  <label for="">Staff Name</label>
                  <input type="text" class="form-control" id="" placeholder="Staff Name" name="staffname" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" id="p1" placeholder="Password" name="staff_password1" required>
                </div>
                <div class="form-group">
                  <label for="">Confirm Password</label>
                  <input type="password" class="form-control" id="p2" placeholder="Password" name="staff_password2" required>
                </div>
        ...
        <div class="col-md-4 col-md-offset-4">
            <p> &nbsp &nbsp &nbsp &copy; 2017  All Rights Reserved |S3-MCA Department | CET </p>
          </div>
