        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="viewstudent.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> View Student</a>
            </div>
        </div>
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $result = mysqli_query($con,"SELECT * FROM login_student");
              ...
              echo "Student Database is empty!!! Go to Students tab and add a new product";
