        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $bid=$_POST['bookno'];
              $result = mysqli_query($con,"select rdate from issue_register where bookno=$bid");
              ...
              $result = mysqli_query($con,"select regno from issue_register where bookno=$bid");
              $row = mysqli_fetch_array($result);
              $sregno=$row['regno'];
              $result = mysqli_query($con,"update login_student set fine=$fine where regno=$sregno");
              if($result)
              {
                echo "Fine Updated...";
              }
              $result = mysqli_query($con,"Delete FROM issue_register where bookno=$bid");
              if($result)
              {
              ...
              $result = mysqli_query($con,"UPDATE books SET issued=0 where bookno=$bid");
              if($result)
              {
                echo "Books database and Issue Register Updated...";
                header( "refresh:2;url=issue.php" );
              }
              else
              {
