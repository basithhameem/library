        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              echo "No books issued yet!!! Call a student and issue some books !!!";
              while($row = mysqli_fetch_array($result))
                ...
                echo "<td>" . $row['date'] . "</td>";
                echo "<td> <form action='return_confirm.php' method='POST'><input type='hidden' name='bookno' value='".$row["bookno"]."'/><input type='submit' name='submit-btn' class='btn btn-default main-color-bg' value='Return' /></form></td></tr>";
                }
              echo "</table>";
              mysqli_close($con);
              ?>
