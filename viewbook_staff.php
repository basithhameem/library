        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="viewbook_staff.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> View Books</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              echo "Books Database is empty!!! Go to books tab and add a new product";
